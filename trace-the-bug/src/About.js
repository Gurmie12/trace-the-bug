        ...
        <div className="about-body">
            ...
            <div className="container mt-5">
                <div className="row mb-5 justify-content-center person" data-aos="fade-right">
                    ...
                    <div className="col-s6 ml-5">
                        <h2>Gurman Brar</h2>
                        <p>Software Developer At Veer AI (University of Waterloo '24)</p>
                        <p className="text-muted">Aspiring to be a software developer at a biotech company</p>
                    </div>
                </div>
                <div className="row mb-5 justify-content-center person" data-aos="fade-left">
                    <div className="col-s6 mr-5">
                        <h2>Eknoor Singh</h2>
                    ...
                    <div className="col-s6">
                        <img src={eknoor} style={{transform: 'rotate(90deg)'}}></img>
                    </div>
                </div>
                <div className="row mb-5 justify-content-center person" data-aos="fade-right">
                    <div className="col-s6">
                    ...
                    <div className="col-s6 ml-5">
                        ...
                        <p>Engineering Student At McMaster University (McMaster University '24)</p>
                ...
                <div className="row mb-5 justify-content-center person" data-aos="fade-left">
                    <div className="col-s6 mr-5">
                        ...
                        <p className="text-muted">Product Manager at BioTech Company</p>
                    </div>
                    <div className="col-s6">
                        <img></img>
                    </div>
                ...
                <div className="row mb-5 justify-content-center person" data-aos="fade-left">
                    <div className="col-s6 mr-5">
                        ...
                        <p className="text-muted">Plans to be a investment banker at a large bank</p>
                    </div>
                    <div className="col-s6">
                        <img src={kumail}></img>
                    </div>
